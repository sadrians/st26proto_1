...
class XmlTest(TestCase):          
    ...
    def setUpClass(cls):
        ...
        cls.dirPath = os.path.join(util.PROJECT_DIRECTORY, 'sequencelistings', 
                               'static', 'sequencelistings')
         
#         cls.schemaPath = os.path.join(cls.dirPath, 'st26.xsd')
        cls.dtdPath = os.path.join(cls.dirPath, 'ST26SequenceListing_V1_0.dtd')
    ...
    def test_validateXmlDocument(self):
        ...
        testDataDirPath = os.path.join(util.PROJECT_DIRECTORY, 
                                       'sequencelistings', 'testData')
                 
        f1 = os.path.join(testDataDirPath, 'file1.xml')
        f2 = os.path.join(testDataDirPath, 'test1.xml')
...
#         self.assertTrue(util.validateDocumentWithDtd(f, d))
        self.assertTrue(util.validateDocumentWithDtd(f1, self.dtdPath))
        self.assertTrue(util.validateDocumentWithDtd(f2, self.dtdPath))
...
#         valid seql contains the first 2 seqs from f2 - goes via if branch
        f3 = os.path.join(testDataDirPath, 'test3.xml')
...
#         valid seql 20 sequences
        f2 = os.path.join(testDataDirPath, 'test2.xml')
        self.assertTrue(util.validateDocumentWithSchema(f2, util.XML_SCHEMA_PATH))
